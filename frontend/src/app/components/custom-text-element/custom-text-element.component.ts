import { Component, input, output, ElementRef, ViewChild, effect, signal, AfterViewInit } from '@angular/core';
...
export class CustomTextElementComponent implements AfterViewInit {
